      ...
      <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <section className='flex flex-col md:flex-row justify-between lg:items-center mb-6'>
            <aside >
              ...
              />
              <div className={errors.minExperience || errors.maxExperience ? "h-5 " :""}>
        ...
        <section className='flex gap-4 mb-2'>
          <aside  className='flex gap-1 items-center'>
            <input type="radio" {...register("option", { validate: validateRadio })} value="quickApply" />
            <p className='text-sm text-place-color'>Quick Apply</p>
          </aside>
          <aside className='flex gap-1 items-center' >
            <input type="radio" {...register("option", { validate: validateRadio })} value="externalApply" />
